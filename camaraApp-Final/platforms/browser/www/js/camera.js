var app = {
  ...
  cargarFoto: function(pictureSourceType){
    var opciones = {
      quality: 90, //calidad de la camara
      sourceType: pictureSourceType, //origen de la foto (galeria o camara)
      destinationType: Camera.DestinationType.FILE_URI, //destino de la img
      targetWidth: 300, // ancho
      targetHeight: 300, // alto
      cameraDirection: Camera.Direction.FRONT, // Para poner auto la camara fronta, para android no sirve
      correctOrientation: true, // Orientacion de la imagen
      saveToPhotoAlbum: true // para guardar la foto en galeria
    };
